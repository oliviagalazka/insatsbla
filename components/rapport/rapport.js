...
// // renderReportPage-funktion - Uppdaterad för att hantera antalet korrekta svar
// function renderReportPage(parentId) {
//   document.body.className = 'body-reportpage';
...
//     let answers = [];  // Definiera answers här
//     let allCorrect = true;  // Deklarera allCorrect här
//     let correctCount = 0;  // Räkna rätta svar
...
//         if (isCorrect) {
//           correctCount++;  // Plussa på rätta svar
//         } else {
//           allCorrect = false;
//         }
//       }
...
//     // Spara det totala antalet rätta svar i localStorage
//     let totalCorrect = parseInt(localStorage.getItem('totalCorrectAnswers'), 10) || 0;
//     totalCorrect += correctCount; // Lägg till de rätta svaren från denna rapport

//     // Uppdatera totalen i localStorage
//     localStorage.setItem('totalCorrectAnswers', totalCorrect);
...
//   // Spara antalet korrekta svar i localStorage
