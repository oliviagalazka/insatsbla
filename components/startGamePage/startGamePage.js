function renderStartGamePage(parentSelector = 'body') {
    ...
    parent.innerHTML = `
        <div id='content-wrapper'>
            ...
            <div>
                <p>Idag kommer ditt fokus, tålamod och skärpa sättas på prov. Du står på samhällets frontlinje - redo att agera när det gäller liv och säkerhet. Spelar ni flera? Samarbeta nära och spela på en gemensam enhet. Spelar du själv? Då gäller full disciplin - du har bara dig själv.</p>
